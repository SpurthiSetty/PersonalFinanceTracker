...
\begin{longtable}{|p{4cm}|p{3cm}|p{2cm}|p{8cm}|}
...
\subsection{Example: Testing for \texttt{reqQInsightsAccuracy} \RequirementReference{reqkQuality}{reqQInsightsAccuracy}}
...
\subsection{Example: Analyzing \texttt{reqPInsightsSpeed} \RequirementReference{reqkPerformance}{reqPInsightsSpeed}}
...
\subsection{Example: Demonstrating \texttt{reqSDataEncryption} \RequirementReference{reqkSecurity}{reqSDataEncryption}}
...
\begin{figure}[!h]
    \centering
    \scalebox{1}{\includegraphics[width=7cm]{png/github.png}}
